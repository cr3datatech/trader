...
### Account
- Equity: $100,000 (all cash — confirmed from prior entries; API unavailable)
- Cash: $100,000 (100%)
- Buying power: $200,000 (2× margin)
- Daytrade count: 0
- Open positions: none
...
### Market Context
- **WTI**: $86.01–$86.35 | **Brent**: ~$95.75–$96.32 (slight slip from Monday spike)
- **S&P 500 futures**: ES opened 7,160.75 → 7,109.50 (+0.18% premarket); Dow +349 pts (+0.71%) on ceasefire extension hopes
- **VIX**: 19.08 (+9.15%) — elevated; risk-off bias persists
- **Iran/Hormuz**: Trump extended ceasefire indefinitely pending Iran proposal; US naval blockade continues; Strait of Hormuz effectively closed (briefly reopened <1 day then closed again); no timeline for resolution
- **Today's earnings (BMO)**:
  - UNH: Rev $111.7B vs $109.7B est; raised FY EPS >$18.25; stock +7%
  - RTX: EPS $1.78 vs $1.52 est (+17%); Rev $22.08B vs $21.49B est; raised guidance ($93B rev / $6.80 EPS); stock +2.1% at open → fell -3.7% afternoon (FY revenue guidance slightly shy)
  - GE: EPS $1.86 vs $1.60 est; stock -3% (margin compression, fuel-cost warning)
  - HAL: EPS $0.55 vs $0.50 est; Rev $5.4B vs $5.36B est; revenue flat YoY — stock reaction muted
  - NOC: Sales $9.9B, EPS $6.14, backlog $95.6B (record)
- **INTC**: HSBC upgraded Hold→Buy (PT $50→$95) + BNP Paribas upgrade; +2% to ~$67; consensus still $52 avg (outlier call); server CPU shipment growth Q2 catalyst
- **AAPL**: Tim Cook departing Sept 1; John Ternus (Hardware SVP) named CEO — uncertainty on largest S&P component
- **NKE**: Q4 sales guidance -2% to -4% YoY — consumer discretionary headwind
- **AMZN**: +1%+ on $20B+ Anthropic investment pledge
- **Economic calendar**: Pending Home Sales (Mar) 10am ET only; no CPI/PPI/FOMC/jobs today
- **Sector momentum YTD**: Leaders — Energy (+22%), Materials, Industrials, Consumer Staples; Laggards — Technology, Communications, Consumer Discretionary, Financials; Healthcare cooling after early strength

### Trade Ideas
1. **NOC** — Backlog $95.6B (record), $9.9B Q1 sales; structural defense demand from Hormuz/Iran; Industrials sector YTD leader. Entry ~$490–500 on intraday pullback, stop ~$449–450 (-9%), target ~$580 (+17%), R:R ~1.9:1. Confirm price action post-open before entering.
2. **INTC** — Dual analyst upgrades; server CPU tailwind; +2% today ~$67. Entry ~$65–67 on pullback, stop ~$60 (-10%), target ~$85 (+27%), R:R ~2.7:1. High-risk/high-reward — size at 10% max (contrarian vs. consensus $52 avg PT).
3. **HAL** — Energy sector leader YTD; beat Q1; Brent $96+ sustains oilfield services demand. Entry only after ceasefire clarity (binary oil risk). Watchlist only today.

### Risk Factors
- Strait of Hormuz closed = binary escalation risk still live; VIX 19 = keep position sizes ≤15%
- RTX already gapped and reversed — do not chase; let print stabilize 2–3 sessions
- AAPL CEO transition = potential S&P drag if sentiment sours
- NKE guidance = consumer softness signal; avoid Consumer Discretionary
- PDT: 0/3 day trades used — preserve capacity
- Alpaca API 403 and ClickUp/Perplexity keys MISSING — manual oversight required

### Decision
**HOLD** — VIX 19, Hormuz binary risk unresolved, RTX already moved. NOC and INTC on watchlist for Thu–Fri entry if ceasefire clarifies and VIX recedes below 17. No new trades today. Patience > activity.
